...
public class EtudiantDAO {
    ...
    /**
     * Vérifie les identifiants et retourne un objet Etudiant simple
     */
    public Etudiant getByCredentials(String username, String password) {
        try {
            ...
            if (rs.next()) {
                ...
                // ✅ Retourne un Etudiant (pas encore FISE/FISA)
                return new Etudiant(nom, prenom, filiere, promo, dateNaissance, username, password);
            }
