	    ...
	    public choix_FISE(){
	    	try (Connection conn = ConnectionDAO.getConnection()) {
	    	    PreparedStatement stmt = conn.prepareStatement(
	    	        "SELECT  FISE_DEBUT, FISE_FIN FROM PROCEDURE_STATUT ORDER BY ID DESC FETCH FIRST 1 ROWS ONLY"
	    	    );
	    	    ...
	    	    if (rs.next()) {
	    	        ...
	    	        if (!( !now.before(debut) && !now.after(fin))) {
	     ...
	     private void initialize() {
	         ...
	         try {
	             ...
	             List<String> dominantes = dao.getFiseDominantes(conn);
	             tab_domin = dominantes.toArray(new String[0]);

	             conn.close(); 

	         } catch (Exception e) {
	             e.printStackTrace();
	             tab_domin = new String[] {}; 
	         }
	        ...
	        // comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"ESAA", "DARIA", "EDD", "IA-DES", "GET", "BDTN", "CERT", "IA-IR", "IF", "ISN", "IABD", "DLTQ", "ISEMAC", "MCTSE"}));
	         ...
	         lblNewLabel_1.setBounds(67, 10, 345, 25);
	        ...
	        // comboBox_1_3.setModel(new DefaultComboBoxModel(new String[] {"ESAA", "DARIA", "EDD", "IA-DES", "GET", "BDTN", "CERT", "IA-IR", "IF", "ISN", "IABD", "DLTQ", "ISEMAC", "MCTSE"}));
	         ...
	         btnNewButton.setBounds(181, 491, 116, 21);
	         ...
	         btnNewButton_1.setBounds(-2, 14, 85, 21);
	         jframe1.getContentPane().add(btnNewButton_1);
