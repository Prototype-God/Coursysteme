...
public class AdminIHM {
    ...
    private void initialize() {
        ...
        JButton btnNewButton_3 = new JButton("SAISIR DES INFORMATIONS");
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JFrame gestionFrame = new JFrame("Saisir les informations");
                        ...
                        confirmBtn.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent e) {
                                ...
                                try {
                                    ...
                                    String sql = "INSERT INTO ETUDIANT (USERNAME, NOM, PRENOM, FILIERE, PROMO, DATENAISSANCE, PASSWORD, RANG) " +
                                            "VALUES ('" + username + "', '" + nom + "', '" + prenom + "', '" + filiere + "', " + promo + ", " +
                                            "TO_DATE('" + dateNaiss + "', 'YYYY-MM-DD'), '" + password + "', " + rang + ")";
